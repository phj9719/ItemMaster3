<template>
    <div style="max-height:80vh;">
        ...
        <ProcessViewQuery @search="search"></ProcessViewQuery>
...
<script>
import ProcessViewQuery from '../components/ProcessViewQuery.vue';
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.process.href;
