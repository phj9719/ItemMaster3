<template>
    <div style="max-height:80vh;">
        ...
        <MaterialViewQuery @search="search"></MaterialViewQuery>
...
<script>
import MaterialViewQuery from '../components/MaterialViewQuery.vue';
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.material.href;
